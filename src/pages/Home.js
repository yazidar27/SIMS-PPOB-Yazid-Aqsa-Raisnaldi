...
const promos = [
  { id: 1, title: "Saldo Gratis!", description: "Saldo SMS PPOB gratis maksimal Rp25.000 untuk pengguna pertama", bgColor: "bg-red-500", banner:"/assets/Banner 1.png" },
  { id: 2, title: "Diskon listrik!", description: "Diskon untuk setiap pembayaran listrik prabayar/pasca bayar 10%", bgColor: "bg-pink-500", banner:"/assets/Banner 2.png" },
  { id: 3, title: "Promo makan!", description: "Dapatkan voucher makan di restoran favorit Anda dengan melakukan transaksi disini!", bgColor: "bg-blue-500", banner:"/assets/Banner 3.png"},
  { id: 4, title: "Cashback 25%!", description: "Cashback untuk setiap pembayaran voucher game diatas Rp100.000", bgColor: "bg-purple-500",banner:"/assets/Banner 4.png" },
  { id: 5, title: "Buy 1 Get 2!", description: "Dapatkan dua bulan gratis untuk setiap pembelian satu bulan berlangganan televisi.", bgColor: "bg-green-500", banner:"/assets/Banner 5.png" },
];
...
const services = [
  ...
  { name: 'Voucher Makanan', icon: '/assets/Voucher Makanan.png' },
  { name: 'Kurban', icon: '/assets/Kurban.png' },
  { name: 'Zakat', icon: '/assets/Zakat.png' },
  { name: 'Paket Data', icon: '/assets/Paket Data.png' },
];
...
const Home = () => {
  ...
  <section className="flex flex-col items-center space-y-1 w-1/3">
    <img src="/assets/Profile Photo.png" alt="Profile" className="h-10 w-10 rounded-full" />
    ...
    <div>
      ...
      <section className="grid grid-cols-6 gap-4 mb-8">
        {services.map(service => (
          <div key={service.name} className="p-2 bg-gray-100 rounded-lg flex flex-col items-center">
      ...
      <section className="mb-8">
        ...
        <Slider {...sliderSettings}>
          {promos.map((promo) => (
            <div key={promo.id} className={`p-4 ${promo.bgColor} rounded-lg text-white flex flex-col items-center`}>
